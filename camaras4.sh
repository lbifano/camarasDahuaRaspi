...
omxplayer --win '0 384 512 768' -o hdmi rtsp://USUARIO:CLAVE@192.168.88.108:554/cam/realmonitor?channel=5%26subtype=1 &


omxplayer  --subtitles /home/pi/custom.srt --win '512 384 1024 768' -o hdmi rtsp://USUARIO:CLAVE@192.168.88.108:554/cam/realmonitor?channel=7%26subtype=1 &
